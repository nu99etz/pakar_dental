...
<head>
    ...
    <!-- Favicon Website -->
    <link rel="icon" href="<?php echo base_url(); ?>assets/img/logo.png" alt="logo" />
    <!-- CSS -->
...
<body>
    ...
    if ($this->session->userdata('validation')) {
        if ($this->session->userdata('validation') == "success") {
    ?>
            <script language="Javascript">
                swal({
                    ...
                    window.location = "<?php echo base_url();?>frontend";
                });
            </script>
        <?php
        } else {
                ...
                <nav class="navbar navbar-expand-lg navbar-light pt-lg-3 ">
                    <div class="container">
                        ...
                        <div class="navbar-brand">
                            <img src="<?php echo base_url(); ?>assets/img/logo_only.png" alt="logo_only" loading="lazy" />
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <div class="navbar-nav ms-auto">
                                ...
                                <a href="<?php echo base_url(); ?>frontend/panduan" class="nav-link me-lg-3">Panduan</a>
                                <a href="<?php echo base_url(); ?>auth/register" class="btn btn-primary mb-0 mt-4 mt-sm-0">Daftar</a>
                            </div>
                        </div>
                    </div>
                </nav>
            ...
            <div class="row">
                <div class="col-sm-6 ps-4 ps-lg-0">
                    <h1 class="fw-bold mt-lg-5">
                        Sistem Pakar <br />
                        Pendeteksi Penyakit Mulut
                    </h1>
                    <p class="mt-lg-4">Konsultasikan keluhan gejala penyakit mulut yang sedang anda alami pada kami sekarang</p>
                    <a href="<?php echo base_url(); ?>auth" class="btn btn-primary mt-2">Mulai Disini</a>
                </div>
                <div class="col-sm-6">
                    <img src="<?php echo base_url(); ?>assets/img/doctor-woman.png" alt="doctor-woman" loading="lazy" />
                </div>
            </div>
    ...
    <section class="about" id="about">
        <div class="container pt-5 pb-5">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-sm-6">
                    <img class="pb-3 pb-lg-0" src="<?php echo base_url(); ?>assets/img/star.png" alt="start" loading="lazy" />
                </div>
                <div class="col-sm-6">
                    <div class="container p-3 p-lg-0 text">
                        <h1 class="fw-bold mb-3">Sistem Pakar Skrining Penyakit Mulut Dengan Menggunakan Metode Forward Chaining</h1>
    ...
    <section class="step">
        <div class="container pt-5 pb-5">
            <h1 class="fw-bold mb-3">
                Cari Tahu Penyakit Mulut <br />
                Berdasarkan Gejala Yang Kamu Alami
            </h1>
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-sm-4">
    ...
    <section class="try">
        <div class="container pt-5 pb-5">
            <div class="box col-12 p-5">
                ...
                <a href="<?php echo base_url(); ?>konsultasi" class="btn btn-secondary mt-3">Coba Diagnosa</a>
            </div>
        </div>
    </section>
    <!-- Try End -->
    ...
    <footer class="footer">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <a href="#" target="_blank">
                        <img class="maps" src="<?php echo base_url(); ?>assets/img/maps.png" alt="" loading="lazy" />
                    </a>
                ...
                <div class="col-sm-4" id="contact">
                    <h5>Hubungi Kami</h5>
                    <form action="<?php echo base_url(); ?>frontend/addKontak" method="post">
        ...
        <p class="p-2 text-center">Copyright <span class="iconify-inline" data-icon="ant-design:copyright-circle-outlined" data-width="15"></span> 2022 Sistem Pakar Skrining Penyakit Mulut Dengan Menggunakan Metode <b>Forward Chaining</b></p>
    </footer>
    <!-- Footer End -->
