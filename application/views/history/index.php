...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            History
            <small>History Konsultasi</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">History Konsultasi</h3>
                    </div>
                    <div class="box-body">
                        <table id="history" url="<?php echo base_url(); ?>history/ajax" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>No</th>
